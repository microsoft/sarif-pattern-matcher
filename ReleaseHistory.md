...
- FND: Remove the secret format assumption in static validation for rule `SEC101/044.NpmCredentials` in `Security`. [#799](https://github.com/microsoft/sarif-pattern-matcher/pull/799)
