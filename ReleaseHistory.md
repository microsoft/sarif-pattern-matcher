...
- BUG: Eliminate `FormatException` notifications in `SEC101/037.SqlCredentials` due to attempting to decode SQL passwords that aren't base64-encoded strings. [#750](https://github.com/microsoft/sarif-pattern-matcher/pull/750)
