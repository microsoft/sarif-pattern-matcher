...
namespace Microsoft.CodeAnalysis.Sarif.PatternMatcher
{
    ...
    {
        // Hard coded regular expressions for regex sniff testing
        // Monster regex has also been divided in half, into 4, and into 8
        // to test running multiple smaller regexes  rather than one large one.
        ...
        protected override AnalyzeContext DetermineApplicabilityAndAnalyze(AnalyzeContext context, IEnumerable<Skimmer<AnalyzeContext>> skimmers, ISet<string> disabledSkimmers)
        {
            ...
            // 4 x 4 monster regex
            /*if (!RegexEngine.IsMatch(context.CurrentTarget.Contents, m41) &&
                !RegexEngine.IsMatch(context.CurrentTarget.Contents, m42) &&
                !RegexEngine.IsMatch(context.CurrentTarget.Contents, m43) &&
                !RegexEngine.IsMatch(context.CurrentTarget.Contents, m44))
            {
                return context;
            }*/
