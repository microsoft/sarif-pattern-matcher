...
namespace Microsoft.CodeAnalysis.Sarif.PatternMatcher.Plugins.Security.Validators
{
    public class CryptographicPrivateKeyValidatorTests
    {
        ...
        public void CryptographicPrivateKeyValidator_Test()
        {
            ...
            string actualValidationState = CryptographicPrivateKeyValidator.IsValidStatic(ref TestMatchedPattern, ref keyValuePairs, ref validationState, ref fingerprintText, ref message);
