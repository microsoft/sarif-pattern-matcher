...
{
    public class DoNotGrantAllPipelinesAccessToSecureFilesValidator : StaticValidatorBase
    {
        protected override IEnumerable<ValidationResult> IsValidStaticHelper(IDictionary<string, FlexMatch> groups)
        {
            if (!groups.TryGetNonEmptyValue("org", out FlexMatch org) ||
                ...
                !groups.TryGetNonEmptyValue("secureFileId", out FlexMatch secureFileId) ||
