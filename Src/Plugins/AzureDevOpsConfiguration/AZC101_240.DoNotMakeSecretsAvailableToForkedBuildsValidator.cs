...
{
    public class DoNotMakeSecretsAvailableToForkedBuildsValidator : StaticValidatorBase
    {
        protected override IEnumerable<ValidationResult> IsValidStaticHelper(IDictionary<string, FlexMatch> groups)
        {
            if (!groups.TryGetNonEmptyValue("org", out FlexMatch org) ||
                ...
                !groups.TryGetNonEmptyValue("buildDefinitionId", out FlexMatch buildDefinitionId) ||
