...
## Unreleased
- BREAKING: SPAM is now an entirely unsigned tool. This will break an signed upstream callers into our API. [#694](https://github.com/microsoft/sarif-pattern-matcher/pull/694)
